...
$pecahLagi[0] = str_replace('<a href="', '<a target="_blank" href="http://www.ccpro.ml/get/?page=', $pecahLagi[0]);
$pecahLagi[0] = str_replace('/get/?page=IDJA002.HTM', '/', $pecahLagi[0]);
$pecahLagi[0] = str_replace('http://www.goethe-verlag.com/book2/_an_app/IDJA.HTM" target="_blank">', '', $pecahLagi[0]);
$pecahLagi[0] = str_replace('</a><a target="_blank" href="http://www.ccpro.ml/get/?page=', '', $pecahLagi[0]);
$pecahLagi[0] = str_replace('<a target="_blank" href="http://www.ccpro.ml/get/?page=http://', '<a target="_blank" href="http://', $pecahLagi[0]);
